# How can you check if a variable holds a value that is a list? Given two 
# variables, verify whether the values they hold are lists.
...
# You can also use the `isinstance()` built-in function
